...
The [local demo and observability guide](docs/local-demo-and-observability.md) explains how an uncommitted `.env` can opt the complete demonstration into live Grok when network access is available.
